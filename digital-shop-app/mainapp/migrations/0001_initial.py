    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(default='cash', max_length=60, verbose_name='Payment method')),
                ('creation_date', models.DateTimeField(auto_now_add=True, verbose_name='Creation date')),
                ('total_price', models.DecimalField(decimal_places=2, max_digits=7, verbose_name='Total price')),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.address', verbose_name='Address')),
            ],
            options={
                'verbose_name': 'Order',
