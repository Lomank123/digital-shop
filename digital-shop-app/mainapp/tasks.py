...
def delete_expired_carts():
    """
    This task will delete all expired non-archived non-user carts.
    ...
    expired_carts = Cart.objects.filter(creation_date__lte=expiration_date, user=None, is_archived=False)
